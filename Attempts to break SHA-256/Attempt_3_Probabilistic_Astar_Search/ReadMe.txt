...
Sadly it didn't work as repeated probabilistic and/xor/plus (plus especially) tended the values to 0.5, so by round 6/64 no algorithm could do better than 128/256
because every input resulted in [0.5, 0.5, 0.5, ...]
